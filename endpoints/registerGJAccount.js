...
module.exports = {
    ...
    handler: (req, res) => {
        ...
        if (accountID === 72) {
            db.prepare('INSERT INTO messages (subject, body, accID, userName, toAccountID, timestamp) VALUES (?, ?, ?, ?, ?, ?)').run('V2VsY29tZSB0byBHRFBTbm9kZSE=', '', 71, 'GDPSnode Notifications', accountID, Math.floor(Date.now() / 1000));
